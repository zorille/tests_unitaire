...
GENERIQUE:" . $this->dir . "/" . $this->fichier . "_GEN.txt";
	...
	/**
	 * @covers Zorille\framework\fiche_categorie::retrouve_fiche_categorie_param
	 */
	...
	public function testretrouve_fiche_categorie_param() {
		...
		$this->object ->getListeOptions () 
			...
			->method ( 'verifie_variable_standard' ) 
			->will ( $this ->returnValue ( true ) );
		$this ->assertInstanceOf ( 'Zorille\framework\fiche_categorie', $this->object ->retrouve_fiche_categorie_param () );
	}

	/**
	 * @covers Zorille\framework\fiche_categorie::remplir_variable
	 */
	public function testremplir_variable_defaut() {
		...
		$this ->assertInstanceOf ( 'Zorille\framework\fiche_categorie', $this->object ->remplir_variable ( array ( 
	...
	/**
     * @covers Zorille\framework\fiche_categorie::lit_fiche_cat
     */
	...
	/**
	 * @covers Zorille\framework\fiche_categorie::retrouve_fiche_cat
	 */
	public function testRetrouve_fiche_cat_False() {
		$hpom = $this ->createMock('Zorille\framework\hpom' );
	...
	/**
     * @covers Zorille\framework\fiche_categorie::valide_xymon
     */
	...
	/**
	 * @covers Zorille\framework\fiche_categorie::valide_donnees_ressource
	 */
	...
	/**
	 * @covers Zorille\framework\fiche_categorie::valide_instance
	 */
	...
	/**
     * @covers Zorille\framework\fiche_categorie::gestion_fiche_categorie
     */
	...
	/**
     * @covers Zorille\framework\fiche_categorie::convert_hobinv_service_vers_priorite
     */
	...
	/**
     * @covers Zorille\framework\fiche_categorie::retrouve_priorite
     */

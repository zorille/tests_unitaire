...
class hpom_datasTest extends MockedListeOptions {
	...
	/**
	 * @covers Zorille\framework\hpom_datas::retrouve_hpom_param
	 */
	...
	public function testRetrouve_hpom_param() {
		...
		$this->object ->getListeOptions () 
			...
			->method ( 'verifie_variable_standard' ) 
			->will ( $this ->returnValue ( true ) );
		$this ->assertInstanceOf ( 'Zorille\framework\hpom_datas', $this->object ->retrouve_hpom_param () );
	}

	/**
	 * @covers Zorille\framework\hpom_datas::valide_presence_hpom_data
	 */
	...
	/**
	 * @covers Zorille\framework\hpom_datas::connexion
	 */

...
require_once __DOCUMENT_ROOT__ . "/HP/HPOM/hpom_client.class.php";
...
class hpom_clientTest extends MockedListeOptions {
	...
	protected function setUp() {
		...
		$fctsStandard = $this ->createMock ( "fonctions_standards" );
	...
	/**
	 * @covers hpom_client::retrouve_hpom_client_param
	 */
	...
	public function testRetrouve_hpom_client_param() {
		...
		$this ->assertInstanceOf ( "hpom_client", $this->object ->retrouve_hpom_client_param () );
	...
	/**
     * @covers hpom_client::gestion_severite
     */
	...
	/**
     * @covers hpom_client::CreerCommandeHpomClient
     */
...
avec du texte\"", 
	...
	/**
     * @covers hpom_client::envoi_hpom_datas
     */

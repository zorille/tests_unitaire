...
class solarwinds_wsclient_soapTest extends MockedListeOptions {
	...
	protected function setUp() {
		...
		$solarwindsDatas = $this ->createMock ( "solarwinds_datas" );
	...
	/**
	 * @covers solarwinds_wsclient_soap::prepare_connexion
	 */
	...
	/**
	 * @covers solarwinds_wsclient_soap::applique_requete_soap
	 */
	...
	/**
	 * @covers solarwinds_wsclient_soap::Read
	 */
	...
	public function testRead_valide() {
		...
		$this ->assertEquals ( array ( 
				'messages' => array ( 
						'text' => 'DATAS' ) ), $this->object ->Read () );
	}

	/**
	 * @covers solarwinds_wsclient_soap::gestion_erreur
	 */
	...
	/**
	 * @covers solarwinds_wsclient_soap::convertit_donnees
	 */

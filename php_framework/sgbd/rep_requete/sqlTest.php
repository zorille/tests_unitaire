...
require_once __DOCUMENT_ROOT__ . '/sgbd/rep_requete/sql.class.php';
...
class sqlTest extends MockedListeOptions {
	...
	/**
	 * @covers sql::valide_sous_requete
	 */
	...
	/**
	 * @covers sql::traite_type_numeric
	 */

...
class itop_HypervisorTest extends MockedListeOptions {
	...
	protected function setUp() {
		...
		$this->object ->setFormat ( 'Hypervisor' );
	}
				...
				'objects' => array ( 
						array ( 
								...
								'fields' => array ( 
										'name' => 'NOM1' ) ) ), 
				'message' => 'Found: 1' ) ) );
		$this ->assertSame ( $this->object, $this->object ->retrouve_Hypervisor ( 'NAME1' ) );
	}
	...
	public function testcreer_oql() {
		...
		$this ->assertEquals ( "SELECT Hypervisor WHERE name='NAME1'", $this->object ->getOqlCi () );
	}
	...
	public function testgestion_Hypervisor() {
		...
		$this ->assertSame ( $this->object, $this->object ->gestion_Hypervisor ( 'NAME1', 'ORG1', 'active', '2015-02-02' ) );
	}
}
?>

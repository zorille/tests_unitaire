...
class wsclient_soapTest extends Core\MockedListeOptions {
	/**
	 * @var wsclient_soap
	 */
	protected $object;
	...
	protected function setUp() {
		ob_start ();
		$itopDatas = $this->createMock ( 'Zorille\itop\datas' );
		$soap = $this->createMock ( 'Zorille\framework\soap' );
		$this->object = new wsclient_soap ( false, "TESTS wsclient_soap" );
	...
	/**
	 * @covers Zorille\itop\wsclient_soap::prepare_connexion
	 */
	public function testPrepare_connexion_exception1() {
		...
		$this->object->getObjetItopdatas ()
			->expects ( $this->any () )
			->method ( 'recupere_donnees_serveur' )
			->will ( $this->returnValue ( false ) );
		...
		$this->expectExceptionMessage ( '(TESTS wsclient_soap) Aucune definition de itop pour NOM1' );
	...
	public function testPrepare_connexion_exception2() {
		...
		$this->object->getObjetSoap ()
			...
			->will ( $this->returnSelf () );
		$this->expectException ( Exception::class );
		$this->expectExceptionMessage ( '(TESTS wsclient_soap) Il faut un username dans la liste des parametres itop' );
		$this->object->prepare_connexion ( "NOM1" );
	}
	...
	public function testPrepare_connexion_exception3() {
		...
		$this->object->getObjetSoap ()
			...
			->will ( $this->returnSelf () );
		$this->expectException ( Exception::class );
		$this->expectExceptionMessage ( '(TESTS wsclient_soap) Il faut un password dans la liste des parametres itop' );
		$this->object->prepare_connexion ( "NOM1" );
	}
	...
	public function testPrepare_connexion_exception4() {
		...
		$this->object->getObjetSoap ()
			...
			->will ( $this->returnSelf () );
		$this->expectException ( Exception::class );
		$this->expectExceptionMessage ( '(TESTS wsclient_soap) Il faut une url dans la liste des parametres itop' );
		$this->object->prepare_connexion ( "NOM1" );
	}
	...
	/**
	 * @covers Zorille\itop\wsclient_soap::applique_requete_soap
	 */
	...
	public function testApplique_requete_soap() {
		$this->object->getListeOptions ()
			->method ( 'getOption' )
			->will ( $this->returnValue ( false ) );
		$stdclass = new Core\SOAPResult ( true, '', new Core\SOAPResultLog ( new Core\SOAPLogMessage ( "" ) ), new Core\SOAPResultLog ( new Core\SOAPLogMessage ( "" ) ), new Core\SOAPResultLog ( new Core\SOAPLogMessage ( "" ) ) );
	...
	public function testApplique_requete_soap_exception() {
		...
		$this->expectException ( Exception::class );
		$this->expectExceptionMessage ( '(TESTS wsclient_soap) EXCEP1' );
		$this->object->applique_requete_soap ( "TEST", array () );
	}

	/**
	 * @covers Zorille\itop\wsclient_soap::CreateRequestTicket
	 */
	...
	public function testCreateRequestTicket_exception() {
		...
		$this->_prepareSoapRequest ( $this->returnValue ( array () ) );
		$this->expectException ( Exception::class );
		$this->expectExceptionMessage ( '(TESTS wsclient_soap) Le champ ci doit etre un tableau' );
	...
	public function testCreateRequestTicket_valide() {
		$this->object->getListeOptions ()
			->method ( 'getOption' )
			->will ( $this->returnValue ( false ) );
		$stdclass = new Core\SOAPResult ( true, new Core\SOAPResultLog ( array (
				new Core\SOAPLogMessage ( "DATAS" )
		) ), new Core\SOAPResultLog ( new Core\SOAPLogMessage ( "" ) ), new Core\SOAPResultLog ( new Core\SOAPLogMessage ( "" ) ), new Core\SOAPResultLog ( new Core\SOAPLogMessage ( "" ) ) );
		$this->_prepareSoapRequest ( $this->returnValue ( $stdclass ) );
		$this->assertEquals ( array (
				'messages' => array (
						'text' => 'DATAS'
				)
		), $this->object->CreateRequestTicket ( "TITRE", "COMMENTAIRES", "CUSTOMER", array (
				"VIRTUALMACHINE" => "CI_NAME"
		), 2, 2 ) );
	}

	/**
	 * @covers Zorille\itop\wsclient_soap::CreateIncidentTicket
	 */
	...
	public function testCreateIncidentTicket_valide() {
		...
		), $this->object->CreateIncidentTicket ( "TITRE", "COMMENTAIRES", "CUSTOMER", array (
				"VIRTUALMACHINE" => "CI_NAME"
		), 2, 2 ) );
	}

	/**
	 * @covers Zorille\itop\wsclient_soap::SearchObjects
	 */
	...
	public function testSearchObjects_result() {
		...
		), $this->object->SearchObjects ( "SELECT USER1" ) );
	}

	/**
	 * @covers Zorille\itop\wsclient_soap::gestion_erreur
	 */
	...
	public function testgestion_erreur_exception1() {
		$stdclass = new Core\SOAPResult ( false, '', new Core\SOAPResultLog ( new Core\SOAPLogMessage ( "TEST ERREUR" ) ), new Core\SOAPResultLog ( new Core\SOAPLogMessage ( "" ) ), new Core\SOAPResultLog ( new Core\SOAPLogMessage ( "" ) ) );
		$this->expectException ( Exception::class );
		$this->expectExceptionMessage ( '(TESTS wsclient_soap) Erreur durant la requete SOAP' );
	...
	public function testgestion_erreur_exception2() {
		$stdclass = new Core\SOAPResult ( false, '', new Core\SOAPResultLog ( array (
				new Core\SOAPLogMessage ( "TEST ERREUR" )
		) ), new Core\SOAPResultLog ( new Core\SOAPLogMessage ( "" ) ), new Core\SOAPResultLog ( new Core\SOAPLogMessage ( "" ) ) );
		$this->expectException ( Exception::class );
		$this->expectExceptionMessage ( '(TESTS wsclient_soap) TEST ERREUR' );
		$this->object->gestion_erreur ( $stdclass );
	}
	...
	public function testgestion_erreur_warnings() {
		$stdclass = new Core\SOAPResult ( true, '', new Core\SOAPResultLog ( new Core\SOAPLogMessage ( "" ) ), new Core\SOAPResultLog ( array (
				new Core\SOAPLogMessage ( "TEST WARNING" )
		) ), new Core\SOAPResultLog ( new Core\SOAPLogMessage ( "" ) ) );
		$this->assertSame ( $this->object, $this->object->gestion_erreur ( $stdclass ) );
	}

	/**
	 * @covers Zorille\itop\wsclient_soap::creer_SOAPExternalKeySearch_par_name
	 */
	...
	public function testcreer_SOAPExternalKeySearch_par_name() {
		$objet = new Core\SOAPExternalKeySearch ( array (
				new Core\SOAPSearchCondition ( 'name', "TEST" )
		) );
	...
	/**
	 * @covers Zorille\itop\wsclient_soap::convertit_donnees
	 */

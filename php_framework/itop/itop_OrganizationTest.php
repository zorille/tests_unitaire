...
class OrganizationTest extends Core\MockedListeOptions {
	...
	protected function setUp() {
		...
		$this->object ->setFormat ( 'Organization' );
	}
				...
				'objects' => array ( 
						array ( 
								...
								'fields' => array ( 
										'name' => 'NOM1' ) ) ), 
				'message' => 'Found: 1' ) ) );
		$this ->assertSame ( $this->object, $this->object ->retrouve_Organization ( 'NAME1' ) );
	}
	...
	public function testcreer_oql() {
		...
		$this ->assertEquals ( "SELECT Organization WHERE name='NAME1'", $this->object ->getOqlCi () );
	}
	...
	public function testgestion_Organization() {
		...
		$this ->assertSame ( $this->object, $this->object ->gestion_Organization ( 'NAME1', 'CODE1', 'active', 'PARENT_ORG_NAME' ) );
	}
}
?>

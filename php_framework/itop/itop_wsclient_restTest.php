 ...
 */
class itop_wsclient_restTest extends MockedListeOptions {
	/**
	 *
	...
	protected function setUp() {
		...
		$itop_datas = $this ->createMock ( "itop_datas" );
		$curl = $this ->createMock ( "curl" );
		
		$this->object = new itop_wsclient_rest ( false, "itop_wsclient_rest" );
	...
	/**
	 * @covers itop_wsclient_rest::prepare_connexion
	 */
	...
	/**
	 * @covers itop_wsclient_rest::prepare_requete_json
	 */
	...
	public function testprepare_requete_json_valide2() {
		...
		$this ->assertSame ( array ( 
				'code' => 0, 
				'message' => 'T2' ), $this->object ->prepare_requete_json ( array ( 
				'operation' => "core/get" ) ) );
	}
}

 ...
 */
class abstract_logTest extends PHPUnit\Framework\TestCase {
	/**
	 * @var abstract_log
	 */
	protected $object;
	...
	protected function setUp() {
		...
		$log = $this->createMock ( 'logs', array (
				'verbose',
				'valideVerbose' 
		) );
		...
		$this->object = $this->getMockForAbstractClass ( "abstract_log" );
	...
	/**
	 * @covers abstract_log::affiche_ligne
	 */
	...
	/**
	 * @covers abstract_log::affiche_tableau
	 */

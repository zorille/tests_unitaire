...
class datasTest extends Core\MockedListeOptions {
	...
	/**
	 * @covers Zorille\librenms\datas::retrouve_param
	 */
	public function testRetrouve_param_exception1() {
        ...
        $this->expectExceptionMessage( '(TESTS datas) Il manque le parametre : librenms_machines_serveur' );
	...
	/**
	 * @covers Zorille\librenms\datas::valide_presence_data
	 */

...
class datasTest extends Core\MockedListeOptions {
	...
	/**
	 * @covers Zorille\opnsense\datas::retrouve_param
	 */
	public function testRetrouve_param_exception1() {
        ...
        $this->expectExceptionMessage( '(TESTS datas) Il manque le parametre : opnsense_machines_serveur' );
	...
	/**
	 * @covers Zorille\opnsense\datas::valide_presence_data
	 */

...
class vmwareVim25ManagedEntityTest extends MockedListeOptions {
	...
	protected function setUp() {
		...
		$objetVmwareClusterComputeResource = $this ->createMock ( "vmwareClusterComputeResource" );
		$objetVmwareComputeResource = $this ->createMock ( "vmwareComputeResource" );
		$objetVmwareDatacenter = $this ->createMock ( "vmwareDatacenter" );
		$objetVmwareDatastore = $this ->createMock ( "vmwareDatastore" );
		$objetVmwareFolder = $this ->createMock ( "vmwareFolder" );
		$objetVmwareHostSystem = $this ->createMock ( "vmwareHostSystem" );
		$objetVmwareNetwork = $this ->createMock ( "vmwareNetwork" );
		$objetVmwareResourcePool = $this ->createMock ( "vmwareResourcePool" );
		$vmwareVirtualMachine = $this ->createMock ( "vmwareVirtualMachine" );
	...
	private function _prepareWsclient($type = "TypeVMWare") {
		$objetXML = $this ->createMock ( "xml" );
		$objetXML ->expects ( $this ->any () ) 
			->method ( 'renvoi_donnee' ) 
			->will ( $this ->returnValue ( array ( 
				"_" => "ObjMOID", 
				"type" => $type ) ) );
		$getObjectServiceInstance = $this ->createMock ( "vmwareServiceInstance" );
	...
	/**
	 * @covers vmwareVim25ManagedEntity::renvoi_obj
	 */
	...
	/**
	 * @covers vmwareVim25ManagedEntity::creer_Folder_spec
	 */
	...
	/**
	 * @covers vmwareVim25ManagedEntity::creer_Datacenter_spec
	 */
	...
	/**
     * @covers vmwareVim25ManagedEntity::Del_Cluster
     */
	...
	/**
     * @covers vmwareVim25ManagedEntity::Get_Cluster
     */
	...
	/**
	 * @covers vmwareVim25ManagedEntity::Get_Cluster_Name
	 */
	...
	/**
	 * @covers vmwareVim25ManagedEntity::Get_Cluster_Datas
	 */
	...
	public function testGet_Cluster_Name_ClusterComputeResource() {
		...
		$this ->assertInstanceOf ( "vmwareClusterComputeResource", $this->object ->Get_Cluster_Name ( 'NOM1' ) );
	}
	...
	public function testGet_Cluster_Name_ComputeResource() {
		...
		$this ->assertInstanceOf ( "vmwareComputeResource", $this->object ->Get_Cluster_Name ( 'NOM1' ) );
	}

	/**
     * @covers vmwareVim25ManagedEntity::Set_Cluster
     */
	...
	/**
     * @covers vmwareVim25ManagedEntity::Del_Datacenter
     */
	...
	/**
     * @covers vmwareVim25ManagedEntity::Get_Datacenter
     */
	...
	/**
	 * @covers vmwareVim25ManagedEntity::Get_Datacenter_Name
	 */
	...
	public function testGet_Datacenter_Name() {
		...
		$this ->assertInstanceOf ( "vmwareDatacenter", $this->object ->Get_Datacenter_Name ( 'NOM1' ) );
	}

	/**
     * @covers vmwareVim25ManagedEntity::Set_Datacenter
     */
	...
	/**
     * @covers vmwareVim25ManagedEntity::Del_Datastore
     */
	...
	/**
     * @covers vmwareVim25ManagedEntity::Get_Datastore
     */
	...
	/**
	 * @covers vmwareVim25ManagedEntity::Get_Datastore_Name
	 */
	...
	public function testGet_Datastore_Name() {
		...
		$this ->assertInstanceOf ( "vmwareDatastore", $this->object ->Get_Datastore_Name ( 'NOM1' ) );
	}

	/**
     * @covers vmwareVim25ManagedEntity::Set_Datastore
     */
	...
	/**
     * @covers vmwareVim25ManagedEntity::Del_Folder
     */
	...
	/**
     * @covers vmwareVim25ManagedEntity::Get_Folder
     */
	...
	/**
	 * @covers vmwareVim25ManagedEntity::Get_Folder_Name
	 */
	...
	public function testGet_Folder_Name() {
		...
		$this ->assertInstanceOf ( "vmwareFolder", $this->object ->Get_Folder_Name ( 'NOM1' ) );
	}

	/**
     * @covers vmwareVim25ManagedEntity::Set_Folder
     */
	...
	/**
     * @covers vmwareVim25ManagedEntity::Del_HostSystem
     */
	...
	/**
     * @covers vmwareVim25ManagedEntity::Get_HostSystem
     */
	...
	/**
	 * @covers vmwareVim25ManagedEntity::Get_HostSystem_Name
	 */
	...
	public function testGet_HostSystem_Name() {
		...
		$this ->assertInstanceOf ( "vmwareHostSystem", $this->object ->Get_HostSystem_Name ( 'NOM1' ) );
	}

	/**
     * @covers vmwareVim25ManagedEntity::Set_HostSystem
     */
	...
	/**
     * @covers vmwareVim25ManagedEntity::Del_Network
     */
	...
	/**
     * @covers vmwareVim25ManagedEntity::Get_Network
     */
	...
	/**
	 * @covers vmwareVim25ManagedEntity::Get_Network_Name
	 */
	...
	public function testGet_Network_Name() {
		...
		$this ->assertInstanceOf ( "vmwareNetwork", $this->object ->Get_Network_Name ( 'NOM1' ) );
	}

	/**
     * @covers vmwareVim25ManagedEntity::Set_Network
     */
	...
	/**
     * @covers vmwareVim25ManagedEntity::Del_ResourcePool
     */
	...
	/**
     * @covers vmwareVim25ManagedEntity::Get_ResourcePool
     */
	...
	/**
	 * @covers vmwareVim25ManagedEntity::Get_ResourcePool_Name
	 */
	...
	public function testGet_ResourcePool_Name() {
		...
		$this ->assertInstanceOf ( "vmwareResourcePool", $this->object ->Get_ResourcePool_Name ( 'NOM1' ) );
	}

	/**
	 * @covers vmwareVim25ManagedEntity::valide_nom_resourcePool
	 */
	...
	/**
	 * @covers vmwareVim25ManagedEntity::Get_ResourcePool_From_Clusters
	 */
	...
	public function testGet_ResourcePool_From_Clusters_defaultResourcePool() {
		...
		$this ->assertInstanceOf ( "vmwareResourcePool", $this->object ->Get_ResourcePool_From_Clusters ( 'CLUSTER1' ) );
	}
	...
	public function testGet_ResourcePool_From_Clusters_specificResourcePool() {
		...
		$this ->assertInstanceOf ( "vmwareResourcePool", $this->object ->Get_ResourcePool_From_Clusters ( 'CLUSTER1', 'NOM1' ) );
	}

	/**
     * @covers vmwareVim25ManagedEntity::Set_ResourcePool
     */
	...
	/**
     * @covers vmwareVim25ManagedEntity::Del_VirtualMachine
     */
	...
	/**
     * @covers vmwareVim25ManagedEntity::Get_VirtualMachine
     */
	...
	/**
	 * @covers vmwareVim25ManagedEntity::Get_VirtualMachine_Name
	 */
	...
	public function testGet_VirtualMachine_Name() {
		...
		$this ->assertInstanceOf ( "vmwareVirtualMachine", $this->object ->Get_VirtualMachine_Name ( 'NOM1' ) );
	}

	/**
     * @covers vmwareVim25ManagedEntity::Set_VirtualMachine
     */

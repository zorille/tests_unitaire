...
class VirtualDeviceBusSlotInfoTest extends MockedListeOptions {
	/**
	...
	protected function setUp() {
		ob_start ();
		$this->object = new VirtualDeviceBusSlotInfo ( false, "TESTS VirtualDeviceBusSlotInfo" );
	}
	...
	/**
	 * @covers Zorille\framework\VirtualDeviceBusSlotInfo::renvoi_donnees_soap
	 */
	...
	/**
	 * @covers Zorille\framework\VirtualDeviceBusSlotInfo::renvoi_objet_soap
	 */
	public function testrenvoi_objet_soap_renvoi_objet() {
		$object = new arrayObject ();
		$resultat = new soapvar ( $object, SOAP_ENC_OBJECT, "VirtualDeviceBusSlotInfo" );

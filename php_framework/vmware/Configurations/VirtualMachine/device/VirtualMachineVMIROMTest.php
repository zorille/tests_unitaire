...
class VirtualMachineVMIROMTest extends MockedListeOptions {
	/**
     * @var VirtualMachineVMIROM
     */
	protected $object;
	...
	protected function setUp() {
		ob_start ();
		$this->object = new VirtualMachineVMIROM ( false, "VirtualMachineVMIROM" );
	}
	...
	/**
	 * @covers Zorille\framework\VirtualMachineVMIROM::renvoi_donnees_soap
	 */
	...
	/**
	 * @covers Zorille\framework\VirtualMachineVMIROM::renvoi_objet_soap
	 */
	public function testrenvoi_objet_soap_renvoi_objet() {
		$object = new arrayObject ();
		$resultat = new soapvar ( $object, SOAP_ENC_OBJECT, "VirtualMachineVMIROM" );

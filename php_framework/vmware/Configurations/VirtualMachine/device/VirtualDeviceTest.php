...
class VirtualDeviceTest extends MockedListeOptions {
	...
	protected function setUp() {
		ob_start ();
		$this->object = $this->getMockForAbstractClass ( 'Zorille\framework\VirtualDevice' );
	}
	...
	/**
	 * @covers Zorille\framework\VirtualDevice::renvoi_donnees_soap
	 */
	public function testrenvoi_donnees_soap_Valide() {
		$diskBackingInfo = $this->createMock('Zorille\framework\VirtualCdromAtapiBackingInfo' );
		$diskBackingInfo->expects ( $this->any () )
			->method ( 'renvoi_objet_soap' )
			->will ( $this->returnValue ( array (
				"DiskBackingInfo" 
		) ) );
		$connectable = $this->createMock('Zorille\framework\VirtualDeviceConnectInfo' );
		$connectable->expects ( $this->any () )
			->method ( 'renvoi_objet_soap' )
			->will ( $this->returnValue ( array (
				"VirtualDeviceConnectInfo" 
		) ) );
		$deviceInfo = $this->createMock('Zorille\framework\Vmware_Description' );
		$deviceInfo->expects ( $this->any () )
			->method ( 'renvoi_donnees_soap' )
			->will ( $this->returnValue ( array (
				"Vmware_Description" 
		) ) );
		$slotInfo = $this->createMock('Zorille\framework\VirtualDeviceBusSlotInfo' );

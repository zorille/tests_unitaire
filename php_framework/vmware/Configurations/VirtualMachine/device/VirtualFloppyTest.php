...
class VirtualFloppyTest extends MockedListeOptions {
	/**
     * @var VirtualFloppy
     */
	protected $object;
	...
	protected function setUp() {
		ob_start ();
		$this->object = new VirtualFloppy ( false, "TESTS VirtualFloppy" );
	}
	...
	/**
	 * @covers Zorille\framework\VirtualFloppy::renvoi_donnees_soap
	 */
	...
	/**
	 * @covers Zorille\framework\VirtualFloppy::renvoi_objet_soap
	 */
	public function testrenvoi_objet_soap_renvoi_objet() {
		$object = new arrayObject ();
		$resultat = new soapvar ( $object, SOAP_ENC_OBJECT, "VirtualFloppy" );

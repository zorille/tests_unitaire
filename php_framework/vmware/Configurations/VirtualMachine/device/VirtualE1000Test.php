...
class VirtualE1000Test extends MockedListeOptions {
	/**
     * @var VirtualE1000
     */
	protected $object;
	...
	protected function setUp() {
		ob_start ();
		$this->object = new VirtualE1000 ( false, "TESTS VirtualE1000" );
	}
	...
	/**
	 * @covers Zorille\framework\VirtualE1000::renvoi_donnees_soap
	 */
	...
	/**
	 * @covers Zorille\framework\VirtualE1000::renvoi_objet_soap
	 */
	public function testrenvoi_objet_soap_renvoi_objet() {
		$object = new arrayObject ( array (
				'addressType' => 'Assigned' 
		) );
		$resultat = new soapvar ( $object, SOAP_ENC_OBJECT, "VirtualE1000" );

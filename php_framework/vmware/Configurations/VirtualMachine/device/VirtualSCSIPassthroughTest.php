...
class VirtualSCSIPassthroughTest extends MockedListeOptions {
	/**
     * @var VirtualSCSIPassthrough
     */
	protected $object;
	...
	protected function setUp() {
		ob_start ();
		$this->object = new VirtualSCSIPassthrough ( false, "VirtualSCSIPassthrough" );
	}
	...
	/**
	 * @covers Zorille\framework\VirtualSCSIPassthrough::renvoi_donnees_soap
	 */
	...
	/**
	 * @covers Zorille\framework\VirtualSCSIPassthrough::renvoi_objet_soap
	 */
	public function testrenvoi_objet_soap_renvoi_objet() {
		$object = new arrayObject ();
		$resultat = new soapvar ( $object, SOAP_ENC_OBJECT, "VirtualSCSIPassthrough" );

...
class VirtualDiskSparseVer1BackingInfoTest extends MockedListeOptions {
	/**
	...
	protected function setUp() {
		ob_start ();
		$this->object = new VirtualDiskSparseVer1BackingInfo ( false, "TESTS VirtualDiskSparseVer1BackingInfo" );
	}
	...
	/**
	 * @covers Zorille\framework\VirtualDiskSparseVer1BackingInfo::renvoi_donnees_soap
	 */
	public function testrenvoi_donnees_soap_Exception() {
		$this->object ->setFileName ( "FILENAME" );
		$this ->expectException(Exception::class);
        $this->expectExceptionMessage( '(TESTS VirtualDiskSparseVer1BackingInfo) Il faut un diskMode' );
	...
	public function testrenvoi_donnees_soap() {
		$parent = $this ->createMock('Zorille\framework\VirtualDiskSparseVer1BackingInfo' );
	...
	/**
	 * @covers Zorille\framework\VirtualDiskSparseVer1BackingInfo::renvoi_objet_soap
	 */
	public function testrenvoi_objet_soap_renvoi_objet() {
		...
		$object = new arrayObject ( array ( 
				'fileName' => 'FILENAME', 
				'diskMode' => 'persistent' ) );
		$resultat = new soapvar ( $object, SOAP_ENC_OBJECT, "VirtualDiskSparseVer1BackingInfo" );

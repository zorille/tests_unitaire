...
class VirtualUSBRemoteClientBackingInfoTest extends MockedListeOptions {
	/**
     * @var VirtualUSBRemoteClientBackingInfo
     */
	protected $object;
	...
	protected function setUp() {
		ob_start ();
		$this->object = new VirtualUSBRemoteClientBackingInfo ( false, "TESTS VirtualUSBRemoteClientBackingInfo" );
	}
	...
	/**
	 * @covers Zorille\framework\VirtualUSBRemoteClientBackingInfo::renvoi_donnees_soap
	 */
	public function testrenvoi_donnees_soap_Exception() {
		$this ->expectException(Exception::class);
        $this->expectExceptionMessage( '(TESTS VirtualUSBRemoteClientBackingInfo) Il faut un hostname' );
	...
	/**
	 * @covers Zorille\framework\VirtualUSBRemoteClientBackingInfo::renvoi_objet_soap
	 */
	public function testrenvoi_objet_soap_renvoi_objet() {
		...
		$object = new arrayObject ( array ( 
				'deviceName' => '', 
				'hostname' => 'HOSTNAME' ) );
		$resultat = new soapvar ( $object, SOAP_ENC_OBJECT, "VirtualUSBRemoteClientBackingInfo" );

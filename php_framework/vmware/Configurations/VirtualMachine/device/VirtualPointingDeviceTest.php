...
class VirtualPointingDeviceTest extends MockedListeOptions {
	/**
     * @var VirtualPointingDevice
     */
	protected $object;
	...
	protected function setUp() {
		ob_start ();
		$this->object = new VirtualPointingDevice ( false, "VirtualPointingDevice" );
	}
	...
	/**
	 * @covers Zorille\framework\VirtualPointingDevice::renvoi_donnees_soap
	 */
	...
	/**
	 * @covers Zorille\framework\VirtualPointingDevice::renvoi_objet_soap
	 */
	public function testrenvoi_objet_soap_renvoi_objet() {
		$object = new arrayObject ();
		$resultat = new soapvar ( $object, SOAP_ENC_OBJECT, "VirtualPointingDevice" );

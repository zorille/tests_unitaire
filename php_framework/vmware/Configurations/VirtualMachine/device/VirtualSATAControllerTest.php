...
class VirtualSATAControllerTest extends MockedListeOptions {
	/**
     * @var VirtualSATAController
     */
	protected $object;
	...
	protected function setUp() {
		ob_start ();
		$this->object = new VirtualSATAController ( false, "TESTS VirtualSATAController" );
	}
	...
	/**
	 * @covers Zorille\framework\VirtualSATAController::renvoi_donnees_soap
	 */
	public function testrenvoi_donnees_soap_Exception() {
		$this ->expectException(Exception::class);
        $this->expectExceptionMessage( '(TESTS VirtualSATAController) Il faut un busNumber' );
	...
	/**
	 * @covers Zorille\framework\VirtualSATAController::renvoi_objet_soap
	 */
	public function testrenvoi_objet_soap_renvoi_objet() {
		$this->object ->setBusNumber ( 1 );
		$object = new arrayObject ( array ( 
				'busNumber' => 1 ) );
		$resultat = new soapvar ( $object, SOAP_ENC_OBJECT, "VirtualSATAController" );

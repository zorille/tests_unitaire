...
class VirtualParallelPortTest extends MockedListeOptions {
	/**
     * @var VirtualParallelPort
     */
	protected $object;
	...
	protected function setUp() {
		ob_start ();
		$this->object = new VirtualParallelPort ( false, "VirtualParallelPort" );
	}
	...
	/**
	 * @covers Zorille\framework\VirtualParallelPort::renvoi_donnees_soap
	 */
	...
	/**
	 * @covers Zorille\framework\VirtualParallelPort::renvoi_objet_soap
	 */
	public function testrenvoi_objet_soap_renvoi_objet() {
		$object = new arrayObject ();
		$resultat = new soapvar ( $object, SOAP_ENC_OBJECT, "VirtualParallelPort" );

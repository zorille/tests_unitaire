...
class VirtualCdromTest extends MockedListeOptions {
	/**
     * @var VirtualCdrom
     */
	protected $object;
	...
	protected function setUp() {
		ob_start ();
		$this->object = new VirtualCdrom ( false, "TESTS VirtualCdrom" );
	}
	...
	/**
	 * @covers Zorille\framework\VirtualCdrom::renvoi_donnees_soap
	 */
	...
	/**
	 * @covers Zorille\framework\VirtualCdrom::renvoi_objet_soap
	 */
	public function testrenvoi_objet_soap_renvoi_objet() {
		$object = new arrayObject ();
		$resultat = new soapvar ( $object, SOAP_ENC_OBJECT, "VirtualCdrom" );

...
class VirtualDiskTest extends MockedListeOptions {
	...
	/**
	 * @covers VirtualDisk::renvoi_donnees_soap
	 */
	...
	public function testrenvoi_donnees_soap() {
		...
		$shares ->expects ( $this ->any () ) 
			...
			->will ( $this ->returnValue ( array ( 
				"SharesInfo" ) ) );
		$storageIOAllocation = $this ->createMock ( "StorageIOAllocationInfo" );
		$storageIOAllocation ->expects ( $this ->any () ) 
			->method ( 'renvoi_donnees_soap' ) 
			->will ( $this ->returnValue ( array ( 
				"StorageIOAllocationInfo" ) ) );
		$vFlashCacheConfigInfo = $this ->createMock ( "VirtualDiskVFlashCacheConfigInfo" );
	...
	/**
	 * @covers VirtualDisk::renvoi_objet_soap
	 */

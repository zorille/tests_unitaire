...
class VirtualVmxnet3Test extends MockedListeOptions {
	/**
     * @var VirtualVmxnet3
     */
	protected $object;
	...
	protected function setUp() {
		ob_start ();
		$this->object = new VirtualVmxnet3 ( false, "TESTS VirtualVmxnet3" );
	}
	...
	/**
	 * @covers Zorille\framework\VirtualVmxnet3::renvoi_donnees_soap
	 */
	...
	/**
	 * @covers Zorille\framework\VirtualVmxnet3::renvoi_objet_soap
	 */
	public function testrenvoi_objet_soap_renvoi_objet() {
		$object = new arrayObject ( array (
				'addressType' => 'Assigned' 
		) );
		$resultat = new soapvar ( $object, SOAP_ENC_OBJECT, "VirtualVmxnet3" );

...
class VirtualControllerTest extends MockedListeOptions {
	/**
	...
	protected function setUp() {
		ob_start ();
		$this->object = $this ->getMockForAbstractClass ( 'Zorille\framework\VirtualController' );
	}
	...
	/**
	 * @covers Zorille\framework\VirtualController::renvoi_donnees_soap
	 */
	public function testrenvoi_donnees_soap_Exception() {
		$this ->expectException(Exception::class);
        $this->expectExceptionMessage( '(abstract_log) Il faut un busNumber' );
	...
	public function testrenvoi_donnees_soap() {
		...
		$this ->assertEquals ( array ( 
				'busNumber' => 1, 
				'device' => 4 ), $this->object ->renvoi_donnees_soap () );
	}
	...
	/**
	 * @covers Zorille\framework\VirtualController::renvoi_objet_soap
	 */
	public function testrenvoi_objet_soap_renvoi_objet() {
		$this->object ->setBusNumber ( 1 );
		$object = new arrayObject ( array ( 
				'busNumber' => 1 ) );
		$resultat = new soapvar ( $object, SOAP_ENC_OBJECT, "VirtualController" );

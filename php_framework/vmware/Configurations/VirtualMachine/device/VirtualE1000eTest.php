...
class VirtualE1000eTest extends MockedListeOptions {
	/**
     * @var VirtualE1000e
     */
	protected $object;
	...
	protected function setUp() {
		ob_start ();
		$this->object = new VirtualE1000e ( false, "TESTS VirtualE1000e" );
	}
	...
	/**
	 * @covers Zorille\framework\VirtualE1000e::renvoi_donnees_soap
	 */
	...
	/**
	 * @covers Zorille\framework\VirtualE1000e::renvoi_objet_soap
	 */
	public function testrenvoi_objet_soap_renvoi_objet() {
		$object = new arrayObject ( array (
				'addressType' => 'Assigned' 
		) );
		$resultat = new soapvar ( $object, SOAP_ENC_OBJECT, "VirtualE1000e" );

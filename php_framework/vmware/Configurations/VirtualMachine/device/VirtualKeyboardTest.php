...
class VirtualKeyboardTest extends MockedListeOptions {
	/**
     * @var VirtualKeyboard
     */
	protected $object;
	...
	protected function setUp() {
		ob_start ();
		$this->object = new VirtualKeyboard ( false, "VirtualKeyboard" );
	}
	...
	/**
	 * @covers Zorille\framework\VirtualKeyboard::renvoi_donnees_soap
	 */
	...
	/**
	 * @covers Zorille\framework\VirtualKeyboard::renvoi_objet_soap
	 */
	public function testrenvoi_objet_soap_renvoi_objet() {
		$object = new arrayObject ();
		$resultat = new soapvar ( $object, SOAP_ENC_OBJECT, "VirtualKeyboard" );

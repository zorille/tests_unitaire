...
class CustomizationGlobalIPSettingsTest extends MockedListeOptions {
	/**
	...
	protected function setUp() {
		ob_start ();
		$this->object = new CustomizationGlobalIPSettings ( false, "TESTS CustomizationGlobalIPSettings" );
	}
	...
	/**
	 * @covers Zorille\framework\CustomizationGlobalIPSettings::renvoi_donnees_soap
	 */
	public function testrenvoi_donnees_soap() {
		$this->object->setDnsServerList ( array (
				"SERVER1" 
		) )
			->setDnsSuffixList ( array (
				".A.com" 
		) );
	...
	/**
	 * @covers Zorille\framework\CustomizationGlobalIPSettings::renvoi_objet_soap
	 */
	public function testrenvoi_objet_soap_renvoi_objet() {
		$object = new arrayObject ();
		$resultat = new soapvar ( $object, SOAP_ENC_OBJECT, "CustomizationGlobalIPSettings" );

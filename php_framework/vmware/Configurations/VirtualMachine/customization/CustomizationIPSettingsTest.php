...
class CustomizationIPSettingsTest extends MockedListeOptions {
	...
	/**
	 * @covers Zorille\framework\CustomizationIPSettings::renvoi_donnees_soap
	 */
	...
	public function testrenvoi_donnees_soap() {
		$ip = $this ->createMock('Zorille\framework\CustomizationFixedIp' );
		$ip ->expects ( $this ->any () ) 
			->method ( 'renvoi_objet_soap' ) 
			->will ( $this ->returnValue ( array ( 
				"CustomizationIpGenerator" ) ) );
		$ipV6Spec = $this ->createMock('Zorille\framework\CustomizationIPSettingsIpV6AddressSpec' );
	...
	/**
	 * @covers Zorille\framework\CustomizationIPSettings::renvoi_objet_soap
	 */

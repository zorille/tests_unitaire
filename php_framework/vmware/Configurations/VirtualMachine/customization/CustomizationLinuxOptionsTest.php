...
class CustomizationLinuxOptionsTest extends MockedListeOptions {
	/**
     * @var CustomizationLinuxOptions
     */
	protected $object;
	...
	protected function setUp() {
		ob_start ();
		$this->object = new CustomizationLinuxOptions ( false, "TEST CustomizationLinuxOptions" );
	}
	...
	/**
	 * @covers Zorille\framework\CustomizationLinuxOptions::renvoi_donnees_soap
	 */
	...
	/**
	 * @covers Zorille\framework\CustomizationLinuxOptions::renvoi_objet_soap
	 */
	public function testrenvoi_objet_soap_renvoi_objet() {
		$object = new arrayObject ();
		$resultat = new soapvar ( $object, SOAP_ENC_OBJECT, "CustomizationLinuxOptions" );

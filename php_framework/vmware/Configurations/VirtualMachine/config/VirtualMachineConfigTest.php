...
class VirtualMachineConfigTest extends MockedListeOptions {
	...
	protected function setUp() {
		ob_start ();
		$this->object = $this->getMockForAbstractClass ( 'Zorille\framework\VirtualMachineConfig' );
	}
	...
	/**
	 * @covers Zorille\framework\VirtualMachineConfig::renvoi_donnees_soap
	 */
	public function testrenvoi_donnees_soap_Valide() {
		$bootOptions = $this->createMock('Zorille\framework\VirtualMachineBootOptions' );
		$bootOptions->expects ( $this->any () )
			->method ( 'renvoi_donnees_soap' )
			->will ( $this->returnValue ( array (
				"bootOptions" 
		) ) );
		$files = $this->createMock('Zorille\framework\VirtualMachineFileInfo' );

...
class VirtualMachineFileInfoTest extends MockedListeOptions {
	/**
	...
	protected function setUp() {
		ob_start ();
		$this->object = new VirtualMachineFileInfo ( false, "TESTS VirtualMachineFileInfo" );
	}
	...
	/**
	 * @covers Zorille\framework\VirtualMachineFileInfo::renvoi_donnees_soap
	 */
	public function testrenvoi_donnees_soap_Valide() {
		$this->object->setLogDirectory ( "logDirectory" )
			->setSnapshotDirectory ( "snapshotDirectory" )
			->setSuspendDirectory ( "suspendDirectory" )
			->setVmPathName ( "vmPathName" );

...
class vmwareComputeResourceTest extends MockedListeOptions {
	/**
	...
	protected function setUp() {
		...
		$this->object = new vmwareComputeResource ( false, "TESTS vmwareComputeResource" );
	...
	/**
     * @covers Zorille\framework\vmwareComputeResource::ReconfigureComputeResource_Task
     */
	public function testReconfigureComputeResource_Task() {
		$this->assertEquals ( array (
				"RESULTAT SOAP" 
		), $this->object->ReconfigureComputeResource_Task ( "TYPE1", "VirtualMachine" ) );
	}
}

...
class vmwareResourcePoolTest extends MockedListeOptions {
	/**
     * @var vmwareResourcePool
     */
	protected $object;
	...
	protected function setUp() {
		...
		$this->object = new vmwareResourcePool ( false, "TESTS vmwareResourcePool" );
	...
	/**
	 * @covers Zorille\framework\vmwareResourcePool::affiche_les_Tests
	 */

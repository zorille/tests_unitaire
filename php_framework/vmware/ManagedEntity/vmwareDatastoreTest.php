...
class vmwareDatastoreTest extends MockedListeOptions {
	/**
     * @var vmwareDatastore
     */
	protected $object;
	...
	protected function setUp() {
		...
		$this->object = new vmwareDatastore ( false, "TESTS vmwareDatastore" );
	...
	/**
	 * @covers Zorille\framework\vmwareDatastore::affiche_les_Tests
	 */
